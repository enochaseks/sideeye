    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <Box sx={{ mt: 4 }}>
          ...
          <ul>
            <li><strong>With Other Users:</strong> Your profile information, posts, and content are shared with other users according to your privacy settings.</li>
        ...
        <Box sx={{ mt: 4 }}>
          ...
          <Typography variant="body1" paragraph>
            When you delete content, it may remain in our backup systems for a limited time. Deleted content is moved to a temporary storage for 24 hours before permanent deletion, allowing for potential recovery if accidentally deleted.
          </Typography>
        </Box>
